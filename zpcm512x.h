...
#define PCM512x_PAGE000_REG121    (PCM512x_PAGE_BASE(0) + 121)
...
/*
 * Page 0, Register 121, bit 0, DAMD - dac mode control
 *
 * This bit controls the DAC architecture to vary the DAC auditory signature.
 */
#define PCM512x_PAGE000_REG121_DAMD PCM512x_PAGE000_REG121
#define PCM512x_PAGE000_REG121_DAMD_SHIFT   0
#define PCM512x_PAGE000_REG121_DAMD_MASK \
    (1 << PCM512x_PAGE000_REG121_DAMD_SHIFT)
/* Mode1 - New hyper-advanced current-segment architecture */
#define PCM512x_PAGE000_REG121_DAMD_HYPER \
    (0 << PCM512x_PAGE000_REG121_DAMD_SHIFT)
/* Mode2 - Classic PCM1792 advanced current-segment architecture */
#define PCM512x_PAGE000_REG121_DAMD_CLASSIC \
    (1 << PCM512x_PAGE000_REG121_DAMD_SHIFT)
...
extern const struct dev_pm_ops zpcm512x_pm_ops;
extern const struct regmap_config zpcm512x_regmap;
